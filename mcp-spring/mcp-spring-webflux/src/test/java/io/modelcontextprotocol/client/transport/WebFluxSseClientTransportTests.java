...
class WebFluxSseClientTransportTests {
	...
	void testMessageProcessing() {
		...
		JSONRPCRequest testMessage = new JSONRPCRequest(McpSchema.JSONRPC_VERSION, "test-method", "test-id", params);
	...
	void testMultipleMessageProcessing() {
		...
		JSONRPCRequest message1 = new JSONRPCRequest(McpSchema.JSONRPC_VERSION, "method1", "id1", params1);

		Map<String, Object> params2 = new HashMap<>();
		params2.put("key", "value2");
		JSONRPCRequest message2 = new JSONRPCRequest(McpSchema.JSONRPC_VERSION, "method2", "id2", params2);
